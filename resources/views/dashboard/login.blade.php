...
<body>
    <form class='login-form' action="{{ route('admin-panel.login.submit')}}" method="POST">
        @csrf
        <div class="flex-row">
          ...
          <input id="username" class='lf--input'  type="mail" placeholder="Email" name="email">
        </div>
        <div class="flex-row">
          ...
          <input id="password" class='lf--input' type="password" placeholder="Password" name="password">
        </div>
